        ...
        if (t != null) {
            ...
            if (result.length()>3) {
                ...
                try {
                    ...
                    String query = URLEncoder.encode(result, "utf-8");
                    HttpGet httpget = new HttpGet("http://104.211.1.186/api/v1/?key=zuedm4v3pv6v53ew62kmg5rxk&lang=en&text="+query); // Set the action you want to do
